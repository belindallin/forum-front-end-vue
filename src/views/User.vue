      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!--UserFavoritedRestaurantsCard.vue-->
           <UserFavoritedRestaurantsCard :user-favorited-restaurants="FavoritedRestaurants"/>
        </div>
      </div>
    </div>
  </div> 
...
export default {
  ...
  methods: {
    fetchUserProfileData() {
      const {id, name, email, image, Comments, FavoritedRestaurants, Followers, Followings, isFollowed} = dummyData.profile
      this.profile = {
        id,
        name,
        email,
